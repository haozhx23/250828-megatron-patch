...
CHECKPOINT_PATH=${1:-"/workspace/checkpoints/llama3_8b_fp8"}
TENSORBOARD_LOGS_PATH=${2:-"/workspace/tensorboard_logs/llama3_8b_fp8"}
TOKENIZER_ARG=${3:-"MOCK"} # Path to tokenizer model, or "MOCK"
DATA_ARG=${4:-"MOCK"}     # Data prefix, or "MOCK"

# Data cache path (useful for both mock and real data)
DATA_CACHE_PATH="/workspace/built_datasets/benchmark_cache_llama3_8b_fp8"
